...
#example: xvfb-run -a python main.py --env_name simple_spread --display --load "./models/model_2k_3n_commNetMLP" --nprocesses 1 --num_epochs 100 --record_video --video_name "./web/static/source/images/2k_3n_commNetMLP" --commnet --benchmark
def get_args():
